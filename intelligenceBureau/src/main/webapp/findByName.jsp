				...
				<tbody>
					...
					<c:forEach items="${dto}" var="dto">
						<tr>
							...
							<td><a href="registration.jsp" class="btn btn-sm btn-primary">update</a> <a href="deleteByName?officerName=${dto.officerName}" class="btn btn-sm btn-danger">delete</a></td>
						</tr>
					</c:forEach>
				</tbody>
			</table>

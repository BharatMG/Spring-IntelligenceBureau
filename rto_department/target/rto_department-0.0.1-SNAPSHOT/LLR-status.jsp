	...
	<form action="appStaus" method="get">
		...
		<div class="container p-4 mt-3 w-50 border border-dark-subtle">
			...
			<div class="form-floating mb-3">
				<input type="text" name="apporcontact   " class="form-control" id="floatingInput" placeholder="enter contactNumber/applicationNumber" required="required"> <label for="floatingInput">Enter

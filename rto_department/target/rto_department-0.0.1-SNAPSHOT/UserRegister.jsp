				...
				<div class="card-body">
					<div>
						...
						<div class="row">
							<div class="col">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" name="placeOfBirth" id="floatingInput" placeholder="enter placeOfBirth" required="required"> <label for="floatingInput">Enter placeOfBirth</label>
								</div>
							</div>
							<div class="col">
								<div class="form-floating mb-3">
							...
							<div class="col">
								<div class="form-floating mb-3">
									<input type="text" class="form-control" name="qualification" id="floatingInput" placeholder="enter qualification" required="required"> <label for="floatingInput">Enter qualification</label>
								</div>
							</div>
						</div>
